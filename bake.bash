...
if ((BASH_VERSINFO[0] < 4 || (\
  ...
  printf "Error: It's 2082 ，Your bash version is still $(printf '%s.' "${BASH_VERSINFO[@]}") ，bake need bash 4.4+:
    apt install bash       # ubuntu
    brew install bash      # mac : brew
    sudo port install bash # mac : macport"
